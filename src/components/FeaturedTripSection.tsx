...
const trips = [
  ...
  {
    id: "yulla-kanda",
    title: "Highest Krishna Temple",
    highlight: "Yulla Kanda Trek",
    price: "₹6,500",
    date: "8–10 May 2026 (3D/2N)",
    description: "An offbeat spiritual and adventure trek in the Kinnaur district leading to a stunning high-altitude glacial lake.",
    center: [31.54, 78.12],
    markers: [
      { lat: 31.5200, lng: 78.1000, label: 'Yulla Khas Village', color: '#FF6B35', image: "/images/base.png" },
      { lat: 31.5450, lng: 78.1150, label: 'Base Camp', color: '#00CED1', image: "/images/base-camp.png" },
      { lat: 31.5600, lng: 78.1300, label: 'Krishna Temple', color: '#9B59B6', image: "/images/krishna.png" },
    ],
    itinerary: [
      {
        icon: MapPin,
        iconClass: 'exploring',
        iconColor: '#FF6B35',
        title: 'DAY 1: Arrive at Yulla Khas',
        description: 'Reach Yulla Khas village via Tapri. Acclimatize, explore the beautiful village, and stay overnight in a homestay.',
      },
      {
        icon: Tent,
        iconClass: 'camping',
        ...
        description: 'Trek 10 km from the village to the base camp, passing through dense oak and pine forests. Camp under the stars.',
      },
      {
        icon: Mountain,
        iconClass: 'trekking',
        iconColor: '#9B59B6',
        title: 'DAY 3: Glacial Lake & Temple',
        description: 'Trek to the holy Yulla Kanda Lake at 3,895m. Visit the unique Krishna Temple, descend back, and depart.',
      },
    ],
    tripImage: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/cd/Kinnaur_Kailash_from_Kalpa.jpg/1024px-Kinnaur_Kailash_from_Kalpa.jpg",
    downloadLink: "#",
  },
  {
    id: "dharamshala",
